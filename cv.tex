...
\begin{itemize}[leftmargin=0.6cm, label={\textbullet}]
    ...
    \item Working across a C++/Qt codebase targeting both Windows and Linux, with CMake driving the build system; scripting and automation in Python, Bash, and PowerShell; web tooling in JavaScript and TypeScript
\end{itemize}
...
\begin{itemize}[leftmargin=0.6cm, label={\textbullet}]
    \item Designed CDN cost-reduction strategy for the Sense SDK --- cut delivery costs by \emph{80\%} with minimal impact on end-users
        ...
        \end{itemize}
    \item Contributed to the design and implementation of a system to control dynamic traffic rules enforced from the cloud, enhancing the security capabilities of home routers
\end{itemize}
